...
!(function (t, e) {
  ...
  e(document)
    ...
    (e.fn.button.noConflict = function () {
      return (
        (e.fn.button = f), d._jQueryInterface
      );
    });
  var p = "carousel",
    m = ".bs.carousel",
    ...
    y = (function () {
      ...
      return (
        ...
        (n._setActiveIndicatorElement = function (
          t
        ) {
    ...
    S = (function () {
      ...
      return (
        ...
        (n._getDimension = function () {
          return e(this._element).hasClass(
            "width"
          )
            ? "width"
            : "height";
        ...
        (n._addAriaAndCollapsedClass = function (
          t,
          n
        ) {
  ...
  var D =
    ...
    k = (function () {
      for (
        ...
        if (
          D &&
          navigator.userAgent.indexOf(t[e]) >= 0
        )
          return 1;
      return 0;
    })();
      ...
      c =
        -1 !== a
          ? [
              s
                .slice(0, a)
                .concat([s[a].split(l)[0]]),
              [s[a].split(l)[1]].concat(
                s.slice(a + 1)
              ),
            ]
          : [s];
        ...
        inner: {
          ...
          fn: function (t) {
            var e = t.placement,
              ...
              s =
                -1 !==
                ["left", "right"].indexOf(n),
              a =
                -1 === ["top", "left"].indexOf(n);
            return (
              (o[s ? "left" : "top"] =
                r[n] -
                (a
        ...
        (n.hide = function (t) {
          ...
          if (
            ...
            if (
              ...
              this._isShown = !1;
              var o = e(this._element).hasClass(
                "fade"
              );
              if (
                (o &&
  ...
  e(document).on(
    ...
    (e.fn.modal.noConflict = function () {
      return (
        (e.fn.modal = Rt), qt._jQueryInterface
      );
    });
  var Ht = [
      "background",
    ...
    for (
      var i =
        ...
        s = function (t, n) {
          ...
          if (
            -1 ===
            o.indexOf(i.nodeName.toLowerCase())
          )
            return (
      ...
      return (
        ...
        (n.setContent = function () {
          ...
          this.setElementContent(
            e(
              t.querySelectorAll(".tooltip-inner")
            ),
            this.getTitle()
          ),
  ...
  var de = e.fn.tab,
    pe = (function () {
      ...
      return (
        ...
        (n._transitionComplete = function (
          t,
          n,
          i
        ) {
  ...
  (e.fn.toast = _e._jQueryInterface),
    ...
    (e.fn.toast.noConflict = function () {
      return (
        (e.fn.toast = me), _e._jQueryInterface
      );
    }),
    (t.Alert = h),
    (t.Button = d),
